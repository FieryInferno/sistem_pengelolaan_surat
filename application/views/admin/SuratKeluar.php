                  ...
                  <?php
                    switch ($m['status']) {
                      case '0': ?>
                        ...
                        <?php break;
                      case '1': ?>
                        <a href="<?= base_url('admin/surat_keluar/ubah/' . $m['id_pengajuan_surat_keluar']); ?>" class="btn btn-primary"><i class="fas fa-pencil-alt"></i></a> 
                        <a href="<?= base_url('assets/' . $m['file']); ?>" class="btn btn-primary" target="_blank"><i class="fas fa-eye"></i></a>
                        <a href="<?= base_url('admin/surat_keluar/kirim/' . $m['id_pengajuan_surat_keluar']); ?>" class="btn btn-primary"><i class="fas fa-paper-plane"></i></a>
                        <?php break;
                    ...
                    if ($m['id_staff'] == NULL && $m['kepala_p3d'] == NULL && $m['kepala_seksi'] == NULL) { ?>
                      <a href="<?= base_url('admin/surat_keluar/hapus/' . $m['id_pengajuan_surat_keluar']); ?>" class="btn btn-danger"><i class="fas fa-trash-alt"></i></a>
                    <?php }
                  ?>
                </td>
              </tr>
