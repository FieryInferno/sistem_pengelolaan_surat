<div class="container-fluid">
  ...
  <div class="card" style="width: 60%;">
    <div class="card-body">
      <form method="POST" action="<?php echo base_url('admin/surat_keluar/edit/' . $id_surat_keluar) ?>" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <input type="hidden" name="surat_lama" value="<?= $file; ?>">
        </div>
